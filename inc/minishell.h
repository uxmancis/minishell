...
int find_dollars_and_replace(t_box **box, t_x_y_rest_info x_y,
							 int **tmp_dict_quotes_word, t_prompt **prompt);
int no_more_dollars(t_box **box, t_x_y_rest_info x_y,
...
void mng_to_replace_env(t_box **box, t_x_y_rest_info x_y,
						t_prompt **prompt);
...
void mng_to_replace_sec_dollar(t_box **box, t_x_y_rest_info x_y,
							   int **tmp_dict_quotes_word);
...
int get_len_word_2(t_box **box, t_x_y_rest_info x_y, int len_old_total_word,
				   char *old_word_2_check);
void replace_delete(t_box **box, char *str_src, t_x_y_rest_info x_y,
					int len_new_total_word);
void mng_to_replace_delete(t_box **box, t_x_y_rest_info x_y,
						   t_prompt **prompt);
...
void replace_pid_sec_dollar(t_box **box, t_x_y_rest_info x_y, char *str_src,
							int **tmp_dict_quotes_word, int len_new_word);
